...
void lidar_statistics(){ // from lidar_demo()
    const uint8_t dataset = 50;
    char *distance_diag[ 13 ] = {
        "ERROR -13: overexposure",
        "ERROR -12: no object detected",
        "ERROR -11: abnormal TOF image",
    ...
    uint8_t i;
    int16_t measurements[ dataset ], minimum = 30000, maximum = 0;
    float variance = 0, standard_deviation = 0, mean = 0;
